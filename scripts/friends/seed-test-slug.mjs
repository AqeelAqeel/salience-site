...
const row = {
  ...
  friend_personalization_context: [
    "Specific instructions (override auto-detected voice when in conflict):",
    "- If someone asks for pricing, offer a 15-min call instead of quoting numbers.",
    "- Never apologize for a slow reply — just answer the actual question.",
    "- If the sender uses formal language, mirror it; otherwise stay terse.",
    "- For introductions, double-opt-in before forwarding contact info.",
  ].join("\n"),
