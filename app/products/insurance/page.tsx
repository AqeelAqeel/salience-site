  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="pt-32 pb-20 px-4 sm:px-8 lg:px-16 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="scroll-reveal">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-neutral-900 mb-6 leading-tight">
                  ...
                  <span className="text-blue-600">Insurance Brokerages</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a href="mailto:aqeel@aqeelali.com?subject=Insurance Automation Demo Request">
                    <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-xl shadow-lg shadow-blue-500/25">
                      Request a Demo
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 scroll-reveal">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
                ...
                <span className="text-blue-600">Scale Your Agency</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div
                  key={feature.title}
                  className={`scroll-reveal stagger-${(index % 3) + 1} group bg-white rounded-2xl border border-neutral-200 p-6 hover:shadow-xl hover:border-blue-200 transition-all duration-300`}
                >
                  <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center mb-4 group-hover:bg-blue-500 transition-colors">
                    <feature.icon className="w-6 h-6 text-blue-700 group-hover:text-white transition-colors" />
                  </div>
        ...
        <section className="py-20 px-4 sm:px-8 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="scroll-reveal-right">
                <div className="bg-gradient-to-br from-blue-500 to-red-500 rounded-2xl p-8 text-white">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/10 rounded-lg p-4">
                      ...
                      <div className="text-white/80 text-sm">Daily Tasks Automated</div>
                    </div>
                    <div className="bg-white/10 rounded-lg p-4">
                      <div className="text-2xl font-bold">$440</div>
                      <div className="text-white/80 text-sm">Avg Revenue/Day Gained</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 px-4 sm:px-8 lg:px-16 bg-blue-700">
          <div className="max-w-4xl mx-auto text-center scroll-reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              ...
              <span className="text-blue-600">Insurance Agency?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="mailto:aqeel@aqeelali.com?subject=Free Workflow Audit for Insurance Agency">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-xl">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-500 text-sm">AI Automation for Insurance Agencies</p>
              </div>
              <div className="flex items-center gap-6 text-slate-500">
                <Link href="/" className="hover:text-blue-600 transition-colors">Home</Link>
                <Link href="/products/healthcare" className="hover:text-blue-600 transition-colors">Healthcare</Link>
                <Link href="/team" className="hover:text-blue-600 transition-colors">Team</Link>
              </div>
              <div className="flex items-center gap-4">
                <a href="mailto:aqeel@aqeelali.com" className="text-slate-500 hover:text-blue-600 transition-colors">
                  <Mail className="w-5 h-5" />
                </a>
                <a href="tel:+14087180712" className="text-slate-500 hover:text-blue-600 transition-colors">
