          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 scroll-reveal">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
                What We <span className="text-blue-600">Deploy</span>
              </h2>
            </div>
        ...
        <section className="py-20 px-4 sm:px-8 lg:px-16 bg-blue-700">
          <div className="max-w-4xl mx-auto text-center scroll-reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Ready to Deploy{' '}
              <span className="text-blue-600">AI in Your Practice?</span>
            </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-500 text-sm">Custom AI Deployment</p>
              </div>
              <div className="flex items-center gap-6 text-slate-500">
                <Link href="/" className="hover:text-blue-600 transition-colors">Home</Link>
                <Link href="/services/consulting" className="hover:text-blue-600 transition-colors">Consulting</Link>
