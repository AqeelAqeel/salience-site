  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="pt-32 pb-20 px-4 sm:px-8 lg:px-16 bg-gradient-to-b from-blue-50 to-white">
            ...
            <div className="max-w-3xl scroll-reveal">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="mailto:aqeel@aqeelali.com?subject=Workflow Audit Request">
                  <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-xl">
                    Book a Free Audit
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 scroll-reveal">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
                What We <span className="text-blue-600">Analyze</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {consultingServices.map((service, index) => (
                <div
                  key={service.title}
                  className={`scroll-reveal stagger-${(index % 2) + 1} group bg-white rounded-2xl border border-neutral-200 p-8 hover:shadow-xl hover:border-blue-200 transition-all duration-300`}
                >
                  <div className="w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center mb-6 group-hover:bg-blue-500 transition-colors">
        ...
        <section className="py-20 px-4 sm:px-8 lg:px-16 bg-blue-700">
          <div className="max-w-4xl mx-auto text-center scroll-reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              ...
              <span className="text-blue-600">Automation Opportunities?</span>
            </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-500 text-sm">AI Automation Consulting</p>
              </div>
              <div className="flex items-center gap-6 text-slate-500">
                <Link href="/" className="hover:text-blue-600 transition-colors">Home</Link>
                <Link href="/services/deployment" className="hover:text-blue-600 transition-colors">Deployment</Link>
                <Link href="/services/managed" className="hover:text-blue-600 transition-colors">Managed</Link>
              </div>
            </div>
